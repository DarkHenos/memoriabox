// app/twitter-image.tsx - Utilise votre LogoIcon
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <LogoMarkFromYourComponent size={200} />
        </div>
      </div>
    ),
    { ...size }
...
// Version server-safe de votre LogoIcon pour les images OG
function LogoMarkFromYourComponent({ size = 200 }: { size?: number }) {
